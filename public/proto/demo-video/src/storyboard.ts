...
export const scenes: Scene[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      { x: 42, y: 8, w: 6, h: 3, label: "Verified badge", delay: 45 },
    ],
  ...
  },
  {
    ...
    durationSec: 8,
    highlights: [
      { x: 16, y: 22, w: 52, h: 5, label: "Conversational input", delay: 10 },
      { x: 16, y: 28, w: 35, h: 4, label: "Action chips: Context, Reference, Command, Attach", delay: 40 },
    ],
  ...
  },
  {
    ...
    durationSec: 9,
    highlights: [
      { x: 16, y: 36, w: 52, h: 3, label: "Daily Edition: 7 sources, 5 entities", delay: 10 },
      { x: 16, y: 39, w: 52, h: 3, label: "Exposure: $2.4M API spend at risk", delay: 40 },
    ],
  ...
  },
  {
    ...
    durationSec: 11,
    highlights: [
      { x: 16, y: 43, w: 52, h: 30, label: "Need to Know signals", delay: 10 },
      { x: 62, y: 44, w: 6, h: 3, label: "Verified · 3", delay: 50 },
      { x: 17, y: 51, w: 30, h: 2, label: "Your exposure note", delay: 80 },
    ],
  ...
  },
  {
    ...
    durationSec: 10,
    highlights: [
      { x: 16, y: 83, w: 25, h: 14, label: "Next Best Action", delay: 10 },
      { x: 42, y: 83, w: 26, h: 14, label: "Daily Sweep triage", delay: 50 },
    ],
  ...
  },
  {
    ...
    durationSec: 10,
    highlights: [
      { x: 25, y: 20, w: 48, h: 35, label: "What Changed grid", delay: 10 },
      { x: 26, y: 22, w: 10, h: 4, label: "+40% magnitude badge", delay: 50 },
    ],
  ...
  },
  {
    ...
    durationSec: 10,
    highlights: [
      { x: 25, y: 56, w: 48, h: 4, label: "WHY NOW evidence chips", delay: 10 },
      { x: 25, y: 62, w: 48, h: 16, label: "What to Watch calendar", delay: 50 },
    ],
  ...
  },
  {
    ...
    durationSec: 9,
    highlights: [
      { x: 25, y: 78, w: 48, h: 14, label: "Actions table: owner, priority, deadline", delay: 10 },
      { x: 25, y: 94, w: 48, h: 5, label: "7 primary sources with dates", delay: 50 },
    ],
  ...
  },
  {
    ...
    durationSec: 9,
    highlights: [
      { x: 80, y: 4, w: 20, h: 35, label: "Briefing Agent panel", delay: 10 },
      { x: 80, y: 68, w: 20, h: 10, label: "Entity list with status", delay: 50 },
    ],
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    durationSec: 7,
    highlights: [
      { x: 6, y: 0, w: 16, h: 3.5, label: "Home · Reports · Chat · Inbox · Me", delay: 10 },
    ],
  ...
  },
  {
    ...
    durationSec: 8,
    highlights: [
      { x: 0, y: 4, w: 8, h: 3, label: "Left rail entity search", delay: 10 },
      { x: 77, y: 0, w: 14, h: 3, label: "Global topbar search", delay: 40 },
    ],
  ...
  },
  {
    ...
    durationSec: 9,
    highlights: [
      { x: 17, y: 44, w: 10, h: 3, label: "Entity mention → popover", delay: 10 },
      { x: 25, y: 20, w: 35, h: 30, label: "Stacking popover cards", delay: 45 },
    ],
  ...
  },
  {
    ...
    durationSec: 9,
    highlights: [
      { x: 17, y: 46, w: 12, h: 2, label: "@mention → inline expand", delay: 10 },
      { x: 32, y: 46, w: 10, h: 2, label: "#tag → popover filter", delay: 40 },
      { x: 17, y: 54, w: 20, h: 3, label: "Backlinks: Referred by...", delay: 70 },
    ],
  ...
  },
  {
    ...
    durationSec: 8,
    highlights: [
      { x: 72, y: 2, w: 14, h: 4, label: "Toast notifications", delay: 10 },
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    durationSec: 10,
    highlights: [
      { x: 15, y: 5, w: 65, h: 4, label: "87 reports · 312 sources · 18 need review", delay: 10 },
      { x: 15, y: 13, w: 65, h: 55, label: "Report card gallery", delay: 40 },
    ],
  ...
  },
  {
    ...
    durationSec: 8,
    highlights: [
      { x: 0, y: 5, w: 10, h: 40, label: "Universe / Company tree", delay: 10 },
    ],
  ...
  },
  {
    ...
    durationSec: 8,
    highlights: [
      { x: 15, y: 9, w: 55, h: 3, label: "Gallery · Board · Table · Graph views", delay: 10 },
      { x: 15, y: 9, w: 55, h: 3, label: "Status filters: All 87 · Verified 12 · Review 18", delay: 40 },
    ],
  ...
  },
  {
    ...
    durationSec: 10,
    highlights: [
      { x: 80, y: 4, w: 20, h: 60, label: "Entity Agent panel", delay: 10 },
      { x: 80, y: 13, w: 10, h: 5, label: "5/5 claims verified", delay: 40 },
      { x: 90, y: 13, w: 10, h: 5, label: "12 sources", delay: 60 },
    ],
  ...
  },
  {
    ...
    durationSec: 10,
    highlights: [
      { x: 15, y: 13, w: 18, h: 22, label: "Anthropic report card", delay: 10 },
      { x: 15, y: 22, w: 18, h: 3, label: "Source links: Reuters, TechCrunch", delay: 50 },
      { x: 15, y: 30, w: 18, h: 3, label: "Signal sparkline + Notebook Ready", delay: 75 },
    ],
...

  {
    ...
    highlights: [
      ...
      { x: 15, y: 9, w: 25, h: 3, label: "Topology modes: Force · Hierarchy · Radial · TDA", delay: 50 },
    ],
  ...
  },
  {
    ...
    durationSec: 9,
    highlights: [
      { x: 15, y: 13, w: 65, h: 50, label: "Kanban board by verification status", delay: 10 },
    ],
  ...
  },
  {
    ...
    durationSec: 9,
    highlights: [
      { x: 15, y: 13, w: 18, h: 22, label: "Report card → notebook editor", delay: 10 },
      { x: 16, y: 30, w: 15, h: 2, label: "AI writing chip: Write with AI", delay: 50 },
    ],
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    durationSec: 10,
    highlights: [
      { x: 12, y: 5, w: 68, h: 5, label: "Coverage Agent: 5 entities · 48 sources", delay: 10 },
      { x: 27, y: 35, w: 42, h: 25, label: "Agent analysis with tool badges", delay: 40 },
    ],
  ...
  },
  {
    ...
    durationSec: 8,
    highlights: [
      { x: 0, y: 5, w: 10, h: 40, label: "Thread list: Active / Recent / Archived", delay: 10 },
    ],
  ...
  },
  {
    ...
    durationSec: 10,
    highlights: [
      { x: 27, y: 44, w: 42, h: 14, label: "Structured changes block", delay: 10 },
      { x: 27, y: 53, w: 25, h: 2, label: "Tool badges: entity_diff, signal_extract", delay: 50 },
    ],
  ...
  },
  {
    ...
    durationSec: 9,
    highlights: [
      { x: 80, y: 4, w: 20, h: 55, label: "Session context: Progress + Artifacts + Agents + Sources", delay: 10 },
    ],
  ...
  },
  {
    ...
    durationSec: 8,
    highlights: [
      { x: 27, y: 55, w: 35, h: 3, label: "Open notebook · Verify claims · Export memo", delay: 10 },
      { x: 27, y: 66, w: 42, h: 4, label: "Live update: 1 report updated, +3 signals", delay: 45 },
    ],
...

  {
    ...
    durationSec: 9,
    highlights: [
      { x: 27, y: 44, w: 42, h: 18, label: "Artifact preview card → full overlay", delay: 10 },
      { x: 50, y: 47, w: 12, h: 2, label: "Version badge + share link", delay: 50 },
    ],
  ...
  },
  {
    ...
    durationSec: 9,
    highlights: [
      { x: 80, y: 35, w: 20, h: 15, label: "Agent memory: edit/delete items", delay: 10 },
      { x: 80, y: 52, w: 20, h: 15, label: "Execution trace: tool calls + data flow", delay: 50 },
    ],
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    durationSec: 10,
    highlights: [
      { x: 25, y: 10, w: 42, h: 10, label: "Priority lanes: 4 Must Clear · 7 Prep · 42 Batch", delay: 10 },
      { x: 25, y: 20, w: 42, h: 28, label: "Selected item detail card", delay: 50 },
    ],
  ...
  },
  {
    ...
    durationSec: 9,
    highlights: [
      { x: 25, y: 20, w: 42, h: 25, label: "Detail card: summary, next steps, why now", delay: 10 },
      { x: 25, y: 35, w: 42, h: 8, label: "Signal Match · Evidence · Calendar", delay: 50 },
    ],
  ...
  },
  {
    ...
    durationSec: 8,
    highlights: [
      { x: 0, y: 5, w: 10, h: 45, label: "Lane + Source filters", delay: 10 },
    ],
  ...
  },
  {
    ...
    durationSec: 9,
    highlights: [
      { x: 80, y: 5, w: 20, h: 55, label: "Context panel: analysis + scenarios + sources", delay: 10 },
      { x: 80, y: 95, w: 20, h: 4, label: "Action buttons: Open memo, Draft reply, Defer", delay: 50 },
    ],
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    durationSec: 10,
    highlights: [
      { x: 23, y: 6, w: 50, h: 60, label: "USER.md: Identity · Decision style · Voice · Watchlist", delay: 10 },
    ],
  ...
  },
  {
    ...
    durationSec: 9,
    highlights: [
      { x: 23, y: 69, w: 50, h: 18, label: "Runtime: Lens · Rules · Report shaping", delay: 10 },
    ],
  ...
  },
  {
    ...
    durationSec: 8,
    highlights: [
      { x: 23, y: 89, w: 50, h: 8, label: "Integrations: HubSpot, Notion connected", delay: 10 },
      { x: 23, y: 97, w: 50, h: 3, label: "Founder plan: $49/mo · 8/200 calls", delay: 45 },
    ],
  ...
  },
  {
    ...
    durationSec: 9,
    highlights: [
      { x: 0, y: 27, w: 10, h: 8, label: "847 observations · 23 corrections", delay: 10 },
      { x: 80, y: 5, w: 20, h: 35, label: "Profile Agent: voice analysis", delay: 50 },
    ],
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    durationSec: 8,
    highlights: [
      { x: 88, y: 0.5, w: 5, h: 2.5, label: "Wide toggle (W key)", delay: 10 },
      { x: 10, y: 63, w: 70, h: 20, label: "4-column What Changed grid", delay: 40 },
    ],
  ...
  },
  {
    ...
    durationSec: 7,
    highlights: [
      { x: 88, y: 0.5, w: 5, h: 2.5, label: "Theme toggle", delay: 10 },
    ],
  ...
  },
  {
    ...
    durationSec: 7,
    highlights: [
      { x: 77, y: 0.5, w: 15, h: 2.5, label: "Cmd+K: Global search", delay: 10 },
    ],
  ...
  },
  {
    ...
    durationSec: 8,
    highlights: [
      { x: 15, y: 13, w: 65, h: 25, label: "All cards: role=button, tabindex=0, aria-label", delay: 10 },
    ],
...

  {
    ...
    durationSec: 9,
    highlights: [
      { x: 57, y: 44, w: 10, h: 3, label: "Verified badge → evidence popup", delay: 10 },
      { x: 35, y: 48, w: 25, h: 12, label: "6-point evidence checklist", delay: 45 },
    ],
