...
- `ownerPrivateNoteProjection`: owner-only private notes, anchors, manual location spot anchors, follow-ups, voice transcripts, and NodeBench handoff context. It excludes public wiki JSON, public `/ask` cache, public answer traces, and other attendees' notes.
