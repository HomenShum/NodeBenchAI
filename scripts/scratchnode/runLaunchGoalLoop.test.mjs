  ...
  it("promotes command evidence to top-level report aliases", () => {
    ...
    expect(summarizeTopLevelCommandEvidence(commandEvidence)).toEqual({
      ...
      commandResults: [
        {
          index: 0,
          command: "npm run repo:housekeeping:check",
          occurrenceIndex: 1,
          exitCode: 0,
          durationMs: 1000,
          timedOut: false,
        ...
        {
          index: 1,
          command: "npm run scratchnode:launch:interactive",
          occurrenceIndex: 1,
          exitCode: 1,
          durationMs: 2000,
          timedOut: false,
...
describe("summarizeNotificationEvidence", () => {
  ...
  it("marks caution-only notifications explicitly", () => {
    expect(
      ...
      notifySuppressedTriggers: [],
      notifyKnownCautionCount: 1,
      notifyKnownCautionPaths: [".worktrees/p0-row-delta"],
      notifyKnownCautionLabels: [".worktrees/p0-row-delta (invalid registered worktree)"],
...
describe("summarizeNotificationEvidence", () => {
  ...
  it("recommends notification when known caution entries remain on an otherwise clean pass", () => {
    expect(
      ...
      notifyKnownCautionPaths: [".worktrees/p0-row-delta"],
      notifyKnownCautionLabels: [
        ".worktrees/p0-row-delta (invalid registered worktree; inspect git metadata first)",
      ],
      notifyKnownCautionOnly: true,
      notifyQuietPassEligible: false,
      notifyRecommended: true,
